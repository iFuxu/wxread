...
# 从环境变量获取加密密钥
KEY = os.getenv('WXREAD_ENCRYPT_KEY') or "3c5c8717f3daf09iop3423zafeqoi"
...
# 从环境变量获取 b_values（示例：WXREAD_B_VALUES="value1,value2,value3"）
env_b_values = os.getenv('WXREAD_B_VALUES')
b_values = env_b_values.split(',') if env_b_values else [
...
# 代理配置
PROXY = os.getenv('WXREAD_PROXY')  # 格式: http://user:pass@host:port
